    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        Optional<Customer> result = customerRepository
            ...
            .map(existingCustomer -> {
                if (customer.getNumDocumento() != null) {
                    existingCustomer.setNumDocumento(customer.getNumDocumento());
                }
                if (customer.getPrimerNombre() != null) {
                    existingCustomer.setPrimerNombre(customer.getPrimerNombre());
                }
                if (customer.getSegundoNombre() != null) {
                    existingCustomer.setSegundoNombre(customer.getSegundoNombre());
                }
                if (customer.getPrimerApellido() != null) {
                    existingCustomer.setPrimerApellido(customer.getPrimerApellido());
                }
                if (customer.getSegundoApellido() != null) {
                    existingCustomer.setSegundoApellido(customer.getSegundoApellido());
                }
