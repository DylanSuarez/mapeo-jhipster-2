...
/**
 * REST controller for managing {@link co.edu.sena.domain.Admin}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AdminResource {
        ...
        Optional<Admin> result = adminRepository
            ...
            .map(existingAdmin -> {
                if (admin.getCargo() != null) {
                    existingAdmin.setCargo(admin.getCargo());
                }
     ...
     */
    @GetMapping("/admins")
    public List<Admin> getAllAdmins(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
